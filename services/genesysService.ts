...
const DNIS_BRANCH_LOOKUP: Record<string, string> = {
  '9647734011011': 'Al-Dolai', '9647735011011': 'Al-Dolai', '9647834011011': 'Al-Dolai', '9647835011011': 'Al-Dolai',
  '9647742101010': 'Al-Krada', '9647746101010': 'Al-Krada', '9647842101010': 'Al-Krada', '9647846101010': 'Al-Krada',
  '9647736121212': 'Al-Sadr - Tawn Hyp.', '9647737121212': 'Al-Sadr - Tawn Hyp.', '9647836121212': 'Al-Sadr - Tawn Hyp.', '9647837121212': 'Al-Sadr - Tawn Hyp.',
  '9647732224446': 'ElMansour', '9647732224447': 'ElMansour', '9647832224447': 'ElMansour', '9647852224447': 'ElMansour',
  '9647722900007': 'Palestine St.', '9647822400007': 'Palestine St.', '9647822900007': 'Palestine St.', '9647722400007': 'Palestine St.',
  '9647734171717': 'Palestine St. - Tawn Hyp.', '9647735171717': 'Palestine St. - Tawn Hyp.', '9647834171717': 'Palestine St. - Tawn Hyp.', '9647835171717': 'Palestine St. - Tawn Hyp.',
  '9647746161616': 'Salehia - Tawn Hyp.', '9647747161616': 'Salehia - Tawn Hyp.', '9647846161616': 'Salehia - Tawn Hyp.', '9647847161616': 'Salehia - Tawn Hyp.',
  '9647736141414': 'Al Jamiya', '9647737141414': 'Al Jamiya', '9647836141414': 'Al Jamiya', '9647837141414': 'Al Jamiya',
  '9647750000403': 'Zayouna', '9647750000406': 'Zayouna', '9647850000403': 'Zayouna', '9647850000406': 'Zayouna'
};
...
export const fetchRealtimeMetrics = async (queueId: string, startDateStr?: string) => {
  ...
  while (true) {
    ...
    if (pageConvs.length < 100 || pageNumber >= 50) break; 
    pageNumber++;
  }
  ...
  totalConversations.forEach((conv: any) => {
    ...
    let dialedDnis = 'Unknown';

    conv.participants?.forEach((p: any) => {
      p.sessions?.forEach((s: any) => {
        if (s.ani && s.ani !== 'Unknown' && callerAni === 'Unknown') {
          callerAni = s.ani.replace('tel:', '').replace('+', '');
        }
        if (s.dnis && s.dnis !== 'Unknown' && dialedDnis === 'Unknown') {
          dialedDnis = s.dnis.replace('tel:', '').replace('+', '');
        }
      });
    });
    ...
    const branchName = DNIS_BRANCH_LOOKUP[dialedDnis] || 'Corporate';
